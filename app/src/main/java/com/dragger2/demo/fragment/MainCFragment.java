...
public class MainCFragment extends BaseFragment{


    private View mView;

    public static MainCFragment getInstance(String content){
        MainCFragment fragmentA=new MainCFragment();
