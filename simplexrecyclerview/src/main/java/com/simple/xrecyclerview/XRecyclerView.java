...
//            Log.d(TAG,"layoutManager.getChildCount()--->"+layoutManager.getChildCount());
//            Log.d(TAG, "lastVisibleItemPosition: ---->"+lastVisibleItemPosition);
//            Log.d(TAG, "adjAdapterItemCount: ----->"+adjAdapterItemCount);
//            Log.d(TAG, "limitNumberToCallLoadMore: ----->"+limitNumberToCallLoadMore);
//            Log.d(TAG, "lastVisibleItemPosition >= adjAdapterItemCount - limitNumberToCallLoadMore---->"+(lastVisibleItemPosition >= adjAdapterItemCount - limitNumberToCallLoadMore));
//            Log.d(TAG, "!isNoMore --->"+(!isNoMore ));
//            Log.d(TAG, "mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING---> "+(mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING));
