...
import static com.simple.xrecyclerview.BaseRefreshHeader.STATE_DONE;


public class SimpleXRecyclerView extends RecyclerView {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    SimpleXRecyclerView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    SimpleXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
