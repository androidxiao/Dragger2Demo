...
public class ShapeViewGroup extends FrameLayout {
    ...
    public ShapeViewGroup setStateBackgroundColor(int normal, int pressed, int unable) {
    ...
    public ShapeViewGroup setBackgroundColorNormal(int colorNormal) {
    ...
    public ShapeViewGroup setBackgroundColorPressed(int colorPressed) {
    ...
    public ShapeViewGroup setBackgroundColorUnable(int colorUnable) {
    ...
    public ShapeViewGroup setBorderWidthNormal(int width) {
    ...
    public ShapeViewGroup setBorderColorNormal(int color) {
    ...
    public ShapeViewGroup setBorderWidthPressed(int width) {
    ...
    public ShapeViewGroup setBorderColorPressed(int color) {
    ...
    public ShapeViewGroup setBorderWidthUnable(int width) {
    ...
    public ShapeViewGroup setBorderColorUnable(int color) {
    ...
    public ShapeViewGroup setCornerRadiusTopLeft(float topLeft) {
    ...
    public ShapeViewGroup setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public ShapeViewGroup setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public ShapeViewGroup setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
